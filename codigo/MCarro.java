...
/**
 * Classe que implementa a interface Manutencao para carros.
 * Esta classe define a lógica de manutenção específica para carros, incluindo critérios para manutenção periódica e troca de pneus,
...
public class MCarro implements Manutencao {
    ...
    private static final double KM_TROCA_PNEUS = 10000;
    private static final double VALOR_PERIODICA = 200.0;
    private static final double VALOR_TROCA_PNEU = 400.0;
